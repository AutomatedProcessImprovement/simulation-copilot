...
class DistributionParameters(Base):
    ...
    id = sa.Column(sa.Integer, primary_key=True, autoincrement=True)
    activity_distribution_id = sa.Column(sa.String, sa.ForeignKey("activity_distributions.id"), nullable=False)
...
class ActivityDistribution(Base):
    ...
    distribution_parameters = sa.orm.relationship("DistributionParameters", backref="activity_distribution")
...
class SimulationModel(Base):
    ...
    id = sa.Column(sa.Integer, primary_key=True, autoincrement=True)
    profiles = sa.orm.relationship("ResourceProfile", backref="simulation_model")
